...
class QNet():
    ...
    def create_model(self, img_shape, architecture='normal'):
        print('Building UNet: {}'.format(architecture))
        ...
        q = getattr(self, '_{}_architecture'.format(architecture))(inputs)

        model = Model(inputs=[references, distorted], outputs=q)
...
class UNet():
    ...
    @staticmethod
    def _normal_architecture(inputs, num_class):
        concat_axis = 3
        ...
        ch, cw = UNet._get_crop_shape(conv4, up_conv5)
        ...
        ch, cw = UNet._get_crop_shape(conv3, up_conv6)
        ...
        ch, cw = UNet._get_crop_shape(conv2, up_conv7)
        ...
        ch, cw = UNet._get_crop_shape(conv1, up_conv8)
        crop_conv1 = Cropping2D(cropping=(ch, cw))(conv1)
        up9 = concatenate([up_conv8, crop_conv1], axis=concat_axis)
        conv9 = Conv2D(32, (3, 3), activation='relu', padding='same')(up9)
        conv9 = Conv2D(32, (3, 3), activation='relu', padding='same')(conv9)

        ch, cw = UNet._get_crop_shape(inputs, conv9)
        conv9 = ZeroPadding2D(padding=((ch[0], ch[1]), (cw[0], cw[1])))(conv9)
        pmap = Conv2D(num_class, (1, 1), activation='sigmoid', name='pmap')(conv9)
    ...
    @staticmethod
    def _deconv_architecture(inputs, num_class):
        concat_axis = 3
    
        conv1 = Conv2D(32, (3, 3), activation='relu', padding='same', name='conv1_1')(inputs)
        conv1 = Conv2D(32, (3, 3), strides=2, activation='relu', padding='same')(conv1)
        
        conv2 = Conv2D(64, (3, 3), activation='relu', padding='same')(conv1)
        conv2 = Conv2D(64, (3, 3), strides=2, activation='relu', padding='same')(conv2)

        conv3 = Conv2D(128, (3, 3), activation='relu', padding='same')(conv2)
        conv3 = Conv2D(128, (3, 3), strides=2, activation='relu', padding='same')(conv3)

        conv4 = Conv2D(256, (3, 3), activation='relu', padding='same')(conv3)
        conv4 = Conv2D(256, (3, 3), strides=2, activation='relu', padding='same')(conv4)

        conv5 = Conv2D(512, (3, 3), activation='relu', padding='same')(conv4)
        conv5 = Conv2D(512, (3, 3), strides=2, activation='relu', padding='same')(conv5)
        
        up_conv5 = Conv2DTranspose(512, (3, 3), strides=2)(conv5) # linear activation
        ch, cw = UNet._get_crop_shape(conv4, up_conv5)
        crop_conv4 = Cropping2D(cropping=(ch, cw))(conv4)
        up6 = concatenate([up_conv5, crop_conv4], axis=concat_axis)
        conv6 = Conv2D(256, (3, 3), activation='relu', padding='same')(up6)
        ...
        up_conv6 = Conv2DTranspose(256, (3, 3), strides=2)(conv6)
        ch, cw = UNet._get_crop_shape(conv3, up_conv6)
        crop_conv3 = Cropping2D(cropping=(ch, cw))(conv3)
        up7 = concatenate([up_conv6, crop_conv3], axis=concat_axis)
        conv7 = Conv2D(128, (3, 3), activation='relu', padding='same')(up7)
        ...
        up_conv7 = Conv2DTranspose(128, (3, 3), strides=2)(conv7)
        ch, cw = UNet._get_crop_shape(conv2, up_conv7)
        crop_conv2 = Cropping2D(cropping=(ch, cw))(conv2)
        up8 = concatenate([up_conv7, crop_conv2], axis=concat_axis)
        conv8 = Conv2D(64, (3, 3), activation='relu', padding='same')(up8)
        ...
        up_conv8 = Conv2DTranspose(64, (3, 3), strides=2)(conv8)
        ch, cw = UNet._get_crop_shape(conv1, up_conv8)
        crop_conv1 = Cropping2D(cropping=(ch, cw))(conv1)
        up9 = concatenate([up_conv8, crop_conv1], axis=concat_axis)
        conv9 = Conv2D(32, (3, 3), activation='relu', padding='same')(up9)
    ...
    @staticmethod    
    def _small_architecture(inputs, num_class):
        concat_axis = 3
        ...
        ch, cw = UNet._get_crop_shape(conv1, up_conv2)
        crop_conv1 = Cropping2D(cropping=(ch, cw))(conv1)
        ...
        ch, cw = UNet._get_crop_shape(inputs, conv3)
        conv3 = ZeroPadding2D(padding=((ch[0], ch[1]), (cw[0], cw[1])))(conv3)
        pmap = Conv2D(num_class, (1, 1), activation='sigmoid', name='pmap')(conv3)
        ...
        q_fmap = Conv2D(num_class, (1, 1), activation='relu', padding='same', name='q_fmap')(pmap)
    ...
    @staticmethod
    def _fixed_res_architecture(inputs, num_class):
        concat_axis = 3
        ...
        pmap = Conv2D(num_class, (1, 1), activation='sigmoid', name='pmap')(multi3)
    ...
    def create_model(self, img_shape, num_class, architecture='normal'):
        print('Building UNet: {}'.format(architecture))
        ...
        # call a _{arch}_architecture methods
        pmap, q = getattr(self, '_{}_architecture'.format(architecture))(inputs, num_class)

        model = Model(inputs=[references, distorted], outputs=[pmap, q])
